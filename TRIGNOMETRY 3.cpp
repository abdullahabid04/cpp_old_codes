...
int main()
{
	while(1)
	{
		...
		cout<<"x = 1 for sin from 0 to 180"<<endl;
		cout<<"x = 2 for sin from 181 to 360"<<endl;
		cout<<"x = 3 for cos from 0 to 180"<<endl;
		cout<<"x = 4 for cos from 181 to 360"<<endl;
		cout<<"x = 5 for tan from 0 to 180"<<endl;
		cout<<"x = 6 for tan from 181 to 360"<<endl;
